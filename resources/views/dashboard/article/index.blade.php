<x-layout-admin>
  ...
  <h1 class="text-2xl font-bold text-gray-800 mb-6">Data Article</h1>
  ...
  <div class="flex justify-start gap-2 items-center">
    ...
    <a href="{{ route('dashboard.article.export_excel') }}" target="_blank"
      class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Export
      Excel
    </a>
  </div>
      ...
      <tbody>
        @forelse ($articles as $article)
          <tr class="bg-white border-b hover:bg-gray-50">
            ...
            <td class="px-6 py-4">
              <img src="{{ asset('storage/' . $article->image) }}" alt="Image" class="w-20 h-20 object-cover">
            </td>
            <td class="px-6 py-4">
        ...
        @empty
          <tr>
            <td colspan="3" class="text-center py-4">No article available</td>
          </tr>
        @endforelse
      </tbody>
    </table>
