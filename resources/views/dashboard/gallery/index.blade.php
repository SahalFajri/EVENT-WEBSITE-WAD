<x-layout-admin>
  ...
  <a href="{{ route('dashboard.gallery.download_pdf') }}"
    class="text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mb-4">Download PDF
  </a>
