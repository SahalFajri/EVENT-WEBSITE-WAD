<x-layout-admin>
  ...
  <h1 class="text-2xl font-bold text-gray-800 mb-6">Data Order Ticket</h1>

  <div class="flex justify-start gap-2 items-center">
    <a href="{{ route('dashboard.order-ticket.download_pdf') }}" target="_blank"
  ...
  <div class="pb-4 mt-4 bg-white">
    ...
    <div class="relative mt-1">
      ...
      <input type="text" id="table-search"
        class="block pt-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-full md:w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500"
      ...
      <tbody>
        @forelse ($orders as $order)
          <tr class="bg-white border-b hover:bg-gray-50">
            ...
            <td class="px-6 py-4">
              {{ $order->details->first()->ticket->name }}
            </td>
            <td class="px-6 py-4">
              {{ $order->status }}
            </td>
            ...
            <td class="px-6 py-4">
              <div class="flex items-center space-x-4">
                <a href="{{ route('dashboard.order-ticket.show', $order->id) }}"
